...
import { AntDesign, Entypo, FontAwesome6, Ionicons, MaterialCommunityIcons, MaterialIcons, SimpleLineIcons } from "@expo/vector-icons";
// @ts-ignore
...
<Text className="text-lg text-white font-bold mt-2">Jayson KAMUGWERA</Text>
...
<View>
        ...
        <Text className="text-gray-700 font-bold py-2 border-b border-secondary">Account Settings</Text>

        <TouchableOpacity className="flex-row items-center pb-3 justify-between"> 
        <View className="flex-row items-center"> 
        <MaterialCommunityIcons name="account" size={24} color="#2B6128" />
        <Text className="ml-4 text-gray-700">Personal Information</Text>
          </View>
          <MaterialIcons name="arrow-forward-ios" size={24} color="#2B6128k" />    
        </TouchableOpacity>


        <TouchableOpacity className="flex-row items-center py-3 justify-between"> 
        <View className="flex-row items-center"> 
        <MaterialIcons name="verified-user" size={24} color="#2B6128" />
        <Text className="ml-4 text-gray-700">Password & Security</Text>
          </View>
          <MaterialIcons name="arrow-forward-ios" size={24} color="#2B6128k" />    
        </TouchableOpacity>
        ...
        <View className="flex-row items-center"> 
        <Ionicons name="notifications" size={24} color="#2B6128" />
        <Text className="ml-4 text-gray-700">Notification Preference</Text>
          </View>
          <MaterialIcons name="arrow-forward-ios" size={24} color="#2B6128k" />    
        </TouchableOpacity>
      ...
      <View className="px-6 bg-white">
        <Text className="text-gray-700 font-bold pb-2  border-b border-secondary">Contact Settings</Text>
        ...
        <TouchableOpacity className="flex-row items-center py-3 justify-between"> 
        <View className="flex-row items-center"> 
        <SimpleLineIcons name="screen-smartphone" size={24} color="#2B6128" />
        ...
        <TouchableOpacity className="flex-row items-center py-3 justify-between"> 
        <View className="flex-row items-center"> 
        <MaterialCommunityIcons name="email-open" size={24} color="#2B6128" />
      ...
      <View className="px-4 bg-white">
        <Text className="text-gray-700 font-bold mb-2 pb-2 border-b  border-secondary">Other</Text>
        <TouchableOpacity className="flex-row items-center py-3 "> 
        <MaterialCommunityIcons name="map-marker-question" size={24} color="#2B6128" />
          <Text className="ml-4 text-gray-700">FAQ</Text>
        </TouchableOpacity>
        <TouchableOpacity className="flex-row items-center py-3 "> 
        <SimpleLineIcons name="earphones-alt" size={24} color="#2B6128" />
